...
def say(phrase, OPTIONS = " -vdefault+f3 -p 40 -s 160 --stdout > say.wav"):
...
def configure():
    try:
        ...
        try:
            os.system("/home/pi/erica/client/start.sh &")
        except:
            os.system("/home/pi/erica/backup/start.sh &")
        finally:
            return
        ...
        for network in networks:
            ...
            try:
                ...
                say("Could not connect to network " + network['SSID'])
                pass

        print "NOT CONNECTED TO INTERNET. RUNNING AD HOC NETWORK."
        say("NOT CONNECTED TO INTERNET. RUNNING AD HOC NETWORK.")
...
if __name__ == "__main__":
    ...
    print "=========================================="
    say("Hello.... I am Starting Erica... Please wait one moment.")
    configure()
