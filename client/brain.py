...
class Brain(object):
    ...
    def __init__(self, mic, profile):
        ...
        self.modules = [
            Gmail, Notifications, Birthday, Weather, Healthfeed, HN, News, Time, Joke, Life, EricaSurf, Repeat, EricaResponse]
        self.modules.append(Unclear)
        self.passivemodules = [Time, EricaResponse, Repeat, EricaSurf]
    ...
    def passivequery(self, text):
        ...
        text -- user input, typically speech, to be parsed by a module
        """
        for module in self.passivemodules:
            if module.isValid(text):
